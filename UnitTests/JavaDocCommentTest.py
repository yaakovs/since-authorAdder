...
class JavaDocCommentTest(unittest.TestCase):
    ...
    def test_oneLineDoc(self):
        ...
        self.assertEqual("/** hello world */", JavaDocComment([str]).init_doc_comment())

    def test_oneLine2Docs(self):
        str = "/** hello world */ \n"
        str2 = "/** hello2 world2 */ class\n"
        self.assertEqual("/** hello2 world2 */", JavaDocComment([str,str2]).init_doc_comment())


    def test_hasClassNoDoc(self):
        str = "/* hello world */ \n"
        str2 = "public static class\n"
        self.assertEqual(None, JavaDocComment([str, str2]).init_doc_comment())
    ...
    def test_realCode(self):
        ...
        self.assertEqual("/** Expands terms of * or / expressions without reordering. \n"
                         ...
                         " * @author Yossi Gil\n"
                         " * @author Niv Shalmon\n"
                         " * @since 2016-08 */", JavaDocComment([str, str2, str3, str4, str5, str6, str7]).init_doc_comment())
    ...
    def test_realCode_getDesc(self):
        ...
        self.assertEqual(" Expands terms of * or / expressions without reordering. \n"
                         " * <p>\n"
                         " * Functions named {@link #base} are non-recursive\n",
                         JavaDocComment([str, str2, str3, str4, str5, str6, str7]).get_desc_from_comment())
    ...
    def test_realCode_getAuth(self):
        ...
        self.assertEqual(" * @author Yossi Gil\n"
                         " * @author Niv Shalmon\n",
                         JavaDocComment([str, str2, str3, str4, str5, str6, str7]).get_author_from_comment())
    ...
    def test_realCode_getAuth_None(self):
        ...
        str7 = "public static class"
        self.assertEqual(None,
                         JavaDocComment([str, str2, str3, str6, str7]).get_author_from_comment())
    ...
    def test_realCode_getAuth_SameLine(self):
        ...
        self.assertEqual(" * @author Yossi Gil "
                         "@author Niv Shalmon \n",
                         JavaDocComment([str, str2, str3, str4, str7]).get_author_from_comment())
    ...
    def test_realCode_getSince(self):
        ...
        self.assertEqual(" * @since 2016-08 \n",
                         JavaDocComment([str, str2, str3, str4, str5, str6, str7]).get_since_from_comment())
    ...
    def test_need_change_since(self):
        ...
        self.assertEqual(True,
                         JavaDocComment([str, str2, str3, str4, str5, str7]).needs_change())
